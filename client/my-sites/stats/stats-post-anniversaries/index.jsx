			...
			<p>
				...
				{ translate(
					...
					'%(yearsAgo)d years ago on this day, {{href}}%(title)s{{/href}} was published.',
					{
						...
						context: 'Stats: Sentence showing what post was published some years ago',
					},
				) }
			</p>
		</StatsContentText>
		...
		<StatsContentText>
			<p>
				{ translate( 'Published on this day in the past years:', {
					context: 'Stats: Sentence preceding the list of posts published in the previous years',
				} ) }
			</p>
		</StatsContentText>
...
const EmptyMessage = localize( ( { translate } ) => (
	<ErrorPanel
		message={ translate( 'No anniversaries today!', {
			context: 'Stats: Info box label when the anniversaries module is empty',
		} ) }
	/>
) );
